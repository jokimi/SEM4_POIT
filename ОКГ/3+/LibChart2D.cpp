...
//--------------------------------------------------------------------
void CPlot2D::SetPenLine(CMyPen& PLine) {					// Установка параметров пера для линии графика
	PenLine.PenStyle = PLine.PenStyle;
	PenLine.PenWidth = PLine.PenWidth;
	PenLine.PenColor = PLine.PenColor;
}
//-------------------------------------------------------------------
void CPlot2D::SetPenAxis(CMyPen& PAxis) {					// Установка параметров пера для линий осей 
