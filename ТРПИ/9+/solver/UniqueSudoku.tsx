...
function _generateUniqueSudoku(solvedArray: string[], e?: React.ChangeEvent<HTMLSelectElement>) {
...
export const getUniqueSudoku = (e?: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    temporaryInitArray = _generateUniqueSudoku(temporarySolvedArray, e);
