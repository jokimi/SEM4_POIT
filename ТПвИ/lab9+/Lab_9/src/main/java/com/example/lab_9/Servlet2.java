...
public class Servlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String connectionString = "jdbc:mysql://localhost:3306/javalab9?autoReconnect=true&useSSL=false";
        ...
        try (Connection connection = DriverManager.getConnection(connectionString, "jokimi", "sonamytabian48"))
        {
            ...
            String sql = "SELECT UserRole FROM Users WHERE UserName = ? AND UserPassword = SHA2(?, 256)";
